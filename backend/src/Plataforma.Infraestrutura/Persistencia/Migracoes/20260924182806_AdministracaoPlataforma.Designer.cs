...
namespace Plataforma.Infraestrutura.Persistencia.Migracoes
{
    ...
    [Migration("20260924182806_AdministracaoPlataforma")]
    partial class AdministracaoPlataforma
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Plataforma.Dominio.Agendamentos.Agendamento", b =>
                {
                    ...
                    b.Property<DateTimeOffset?>("ConsentimentoData")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("consentimento_data");

                    b.Property<string>("ConsentimentoIp")
                        .HasColumnType("text")
                        .HasColumnName("consentimento_ip");

                    b.Property<string>("ConsentimentoVersaoTermos")
                        .HasColumnType("text")
                        .HasColumnName("consentimento_versao_termos");
                    ...
                    b.Property<bool>("Lembrete24hEnviado")
                        .HasColumnType("boolean")
                        .HasColumnName("lembrete24h_enviado");

                    b.Property<bool>("Lembrete2hEnviado")
                        .HasColumnType("boolean")
                        .HasColumnName("lembrete2h_enviado");
            ...
            modelBuilder.Entity("Plataforma.Dominio.Fidelidade.ProgramaFidelidade", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<string>("DescricaoRecompensa")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                    ...
                    b.Property<int>("SelosNecessarios")
                        .HasColumnType("integer")
                        .HasColumnName("selos_necessarios");

                    b.HasKey("Id")
                        .HasName("pk_programas_fidelidade");

                    b.HasIndex("NegocioId")
                        .IsUnique()
                        .HasDatabaseName("ix_programas_fidelidade_negocio_id");

                    b.ToTable("programas_fidelidade", (string)null);
                });

            modelBuilder.Entity("Plataforma.Dominio.Fidelidade.SeloCliente", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
                    ...
                    b.Property<bool>("Resgatado")
                        .HasColumnType("boolean")
                        .HasColumnName("resgatado");

                    b.HasKey("Id")
                        .HasName("pk_selos_cliente");

                    b.HasIndex("AgendamentoId")
                        .IsUnique()
                        .HasDatabaseName("ix_selos_cliente_agendamento_id");

                    b.HasIndex("ClienteId", "Resgatado")
                        .HasDatabaseName("ix_selos_cliente_cliente_id_resgatado");

                    b.ToTable("selos_cliente", (string)null);
                });

            modelBuilder.Entity("Plataforma.Dominio.Financeiro.Pagamento", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
