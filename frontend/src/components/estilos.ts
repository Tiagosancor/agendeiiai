...
export const classeBotaoPerigo =
  "rounded-lg border border-red-300 px-3 py-2 text-sm font-medium text-red-600 transition hover:bg-red-50 dark:border-red-900 dark:text-red-400 dark:hover:bg-red-950";

export const classeCartao =
  "overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-neutral-800 dark:bg-neutral-900";

export const classeTh =
  "px-3 py-2 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400";

export const classeTd = "px-3 py-2 text-sm text-gray-800 dark:text-neutral-200";
